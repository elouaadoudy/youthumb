...
class MyDocument extends Document {
  render() {
      ...
      <Html lang="en">
        ...
        <body>
          ...
          <div style={{ textAlign: 'center', padding: '10px', backgroundColor: 'lightgray' }}>
            <p><h1>YouTube Thumbnail Downloader</h1>
    ...
    <h2>What is the use of  YouTube Thumbnail Grabber website?</h2>
    <p>People use  YouTube thumbnail downloader website for getting thumbnails from any YouTube videos. That can be used in presentations, animation work, or many other activities.</p>

    <h2>How to use  YouTube Thumbnail Downloader website?</h2>
    ...
    <h2>Compatibility of  YT Thumbnail Grabber website</h2>
